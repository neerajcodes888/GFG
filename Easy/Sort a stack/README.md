<h2><a href="https://practice.geeksforgeeks.org/problems/sort-a-stack/1?page=1&category[]=Stack&sortBy=submissions">Sort a stack</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a stack, the task is to sort&nbsp;it such that the top of the stack has the greatest&nbsp;element.</span></p>
