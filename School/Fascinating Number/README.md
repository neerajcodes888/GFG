<h2><a href="https://practice.geeksforgeeks.org/problems/fascinating-number3751/1?page=1&sortBy=difficulty">Fascinating Number</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong>. Your task is to check whether it is fascinating or not.<br>
